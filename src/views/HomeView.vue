            ...
            <v-window-item :value="1">
              <v-row>
                ...
                <v-col cols="12" sm="6" class="blue rounded-bl-xl">
                  <div style="text-align: center; padding: 120px 100px;">
                    <v-card-text class="white--text">
                      <h3 class="text-center">Don't Have an Account Yet?</h3>
                      <h6 class="text-center">Let's get you all set up so you can start creating your first<br>
                ...
                <v-col cols="12" sm="6" class="blue ronded-br-xl">
                  <div style="text-align: center; padding: 180px 0;">
                    <v-card-text class="white--text">
                      ...
                      <h6 class="text-center">SignLog in to your account so you can continue building and<br>
